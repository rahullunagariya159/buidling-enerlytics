...
import { createProject, listProjects, updateGuestLogin, getPlans, getPromoDetails, saveCard } from './Services/UserService';
...
const stripePromise = loadStripe('pk_test_51MZ8dBF9eqYsOIGC0tvh8yRVb2Oo93rIKutAJISmU9GzYL01ORwSAc63OcPmQby3oEiS8xgqBtEfwe9DFGZyAlqC00B2TbfJ1E');
...
function Dashboard() {
        ...
        .then(response => {
          if (response.error) {
            ...
            if (response && response.msg) {
              ReactSession.set('project_id', response.msg[0].id);
              if (isGuestUser) {
                setTimeout(window.location.href = '/create-project?name=' + projectNameElm.value + '&&skip=true', 2000);
              } else {
                setTimeout(window.location.href = '/create-project?name=' + projectNameElm.value, 2000);
              }
            }
          }
        });
    ...
    if (data && data.paymentMethod) {
      ...
      saveCard(payload)
        .then(response => {
          ...
          if (response.error) {
            ...
            if (response.data) {
              ...
              document.getElementById('paymentMethod').classList.remove('no-card-added');
              document.getElementById("enablePromo").click();
              document.getElementById('SECURE-RELIABLE').classList.remove('show');
        ...
        .catch(err => {
          console.log(err);
          setAddCardClicked(false);
          toast.error('Something went wrong while making the payment. Please try again.', { toastId: 'toast11' });
        });
    }
  }
  ...
  return (
    <div>
                ...
                <div className="cntr-area">
                  <div className="modeler-box">
                    ...
                    <div className="grid-wlcm">
                      <h1 className="WELCOME-title">WELCOME T<span className="botm-brdr">O THE </span><span className="cimr">BE Modeler <sup><img src="" className="rr2" alt="" /></sup></span></h1>
                      <p className="wlcm-pra p-1">Lorem Ipsum is simply dummy text of the printing and typesetting
                        <span className="block-indus">industry. Lorem Ipsum has been the industry's.</span></p>
                    </div>
                    <div className="PROJECT-btns">
                      {isGuestUser == false && (
                        <a data-bs-toggle="modal" data-bs-target="#STARTPROJECT" className="PROJECT-one">START NEW PROJECT</a>
                      )}
                      {isGuestUser !== false && !createProjectClicked && (
                        <a className="PROJECT-one" onClick={handleCreateProjectForGuest}>START NEW PROJECT</a>
                      )}
                      {isGuestUser !== false && createProjectClicked && (
                        <a className="PROJECT-one loading-button"><i class="fa fa-spinner fa-spin"></i> START NEW PROJECT</a>
                      )}


                      <a id="loadProjects" className="PROJECT-one tow load-existing" onClick={() => navigate('/load-project')} disabled={isGuestUser || projectList.length === 0}>LOAD AN EXISTING PROJECT</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <a id="enablePlans" data-bs-toggle="modal" data-bs-target="#CHOOSEPLAN" hidden >Choose Plans</a>
      <a id="enablePromo" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#PROMOCODE" hidden >Promo Code</a>
      <a id="enableCard" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#SECURE-RELIABLE" hidden >Choose Card</a>

      {/* <!-- Modal --> */}
      <div className="modal fade" id="STARTPROJECT" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog signin">
          <div className="modal-content signin START">
            <div>
              <button type="button clickable" className="x-btn" data-bs-dismiss="modal" aria-label="Close">x</button>
            </div>
            <div className="modal-header-flex">
              <h1 className="start-title"><span className="botm-brdr">START N</span>EW PROJECT</h1>
            </div>
            <div className="start-grid">
              <div>
                <input type="text" id="projectName" placeholder="Project Name" className="Project-input pop-create" />
              </div>
            ...
            <div className="CONTINUE-space">
              <a className="CONTINUE-btn clickable" onClick={handleCreateProject}>CONTINUE</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="modal fade" id="CHOOSEPLAN" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div className="modal-content signup plane">
            <div className="CHww">
              <div className="sdww col-lg-3">
                ...
                <a className="Euroed">Euro <img src="assets/img/Home–new/black-drop.svg" alt="" /></a>
              ...
              <div className="WHAT-we col-lg-6">
                ...
                <p className="WHAT-praw">
                  ...
                  <span className="esdw"> NO SUBSCRIPTION, NO FREQUENT PAYMENTS </span>
                </p>
              </div>
            ...
            <div className="plan-box">
              <div className="first-box">
                <div className="first-space">
                  ...
                  <p className="top-pra">Try out the most robust & user-friendly web tool accessible right now.
                  </p>
                </div>
                <div className="sec-spece">
                  ...
                  <div className="plan-grid">
                    <p className="plan-pra"><img src="assets/img/Choose-plane/checked-verified-1.svg"
                      className="plan-img" alt="" />1 Credit included</p>
                    <p className="plan-pra"><img src="assets/img/Choose-plane/checked-verified-1.svg"
                      className="plan-img" alt="" />1 Project</p>
                    <p className="plan-pra"><img src="assets/img/Choose-plane/checked-verified-1.svg"
                      className="plan-img" alt="" />1 Project configuration</p>
                    <p className="plan-pra"><img src="assets/img/Choose-plane/checked-verified-1.svg"
              ...
              <div className="second-box">
                ...
                <div className="first-space brdt">
                  ...
                  <p className="top-pra orn">Try out the most robust & user-friendly web tool accessible right
                    now.</p>
                </div>
                <div className="sec-spece">
                  <div>
                    <h1 className="plan-title orn">€30</h1>
                    <p className="plan-pra orn">Additional 100 credits for €15</p>
                  </div>
                  <div className="plan-grid">
                    <p className="plan-pra orn"><img src="assets/img/Choose-plane/checked-verified.svg"
                      className="plan-img" alt="" />100 Credits included</p>
                    <p className="plan-pra orn"><img src="assets/img/Choose-plane/checked-verified.svg"
                      className="plan-img" alt="" />100 Credit included</p>
                    <p className="plan-pra orn"><img src="assets/img/Choose-plane/checked-verified.svg"
                      className="plan-img" alt="" />3 Project</p>
                    <p className="plan-pra orn"><img src="assets/img/Choose-plane/checked-verified.svg"
                      className="plan-img" alt="" />10 Project configuration</p>
                    <p className="plan-pra orn"><img src="assets/img/Choose-plane/checked-verified.svg"
                      className="plan-img" alt="" />Detailed analytics</p>
                    <p className="plan-pra orn"><img src="assets/img/Choose-plane/checked-verified.svg"
                      className="plan-img" alt="" />Automatic model calibration</p>
                    <p className="plan-pra orn"><img src="assets/img/Choose-plane/checked-verified.svg"
                      className="plan-img" alt="" />Efficiency & savings calculations</p>
                    <p className="plan-pra orn"><img src="assets/img/Choose-plane/checked-verified.svg"
                      className="plan-img" alt="" />Full standard set of weather data</p>
                  </div>
                  <div>
                    <a className="Try-now-btn orn clickable" onClick={() => redirectToBuy({ 'plan': 'HOME', 'credit': 100, 'cost': 30 })}>Start now</a>
                  </div>
                </div>
              </div>
              <div className="first-box">
                ...
                <div className="sec-spece non">
                  <div>
                    ...
                    <div className="Additional-bra">
                      ...
                      <p className="plan-pra colre">Covers all features of Home</p>
                    </div>
                  </div>
                  <div className="plan-grid">
                    <p className="plan-pra"><img src="assets/img/Choose-plane/checked-verified-1.svg"
                      className="plan-img" alt="" />300 Credits included</p>
                    <p className="plan-pra"><img src="assets/img/Choose-plane/checked-verified-1.svg"
                      className="plan-img" alt="" />Unlimited Projects</p>
                    <p className="plan-pra"><img src="assets/img/Choose-plane/checked-verified-1.svg"
                      className="plan-img" alt="" />20 Project configuration</p>
                    <p className="plan-pra"><img src="assets/img/Choose-plane/checked-verified-1.svg"
                      className="plan-img" alt="" />Individual Weather locations</p>
                  </div>
                  <div>
                    <a className="Try-now-btn clickable" onClick={() => redirectToBuy({ 'plan': 'PROFESSIONAL', 'credit': 300, 'cost': 70 })}>Start now</a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="canter-aline">
                  <div className="second-box">
                    ...
                    <div className="first-space brdt">
                      ...
                      <p className="top-pra orn">Try out the most robust & user-friendly web tool accessible
                        right now.</p>
                    </div>
                    <div className="sec-spece">
                      <div>
                        <h1 className="plan-title orn">€{parseInt(selectedCost)}</h1>
                        <p className="plan-pra orn">Additional 100 credits for €15</p>
                      </div>
                      <div className="plan-grid">
                        <p className="plan-pra orn"><img src="assets/img/Choose-plane/checked-verified.svg"
                ...
                <div className="right-promo-box">
                      ...
                      <div className="w-100">
                        <div className="Credit-box">
                          <div className="card-Credit-box">
                            ...
                            <p className="Credit-card">{selectedCard.cardType}</p>
                            <p className="Defaultw">Default</p>
                          </div>
                          <div>
                        ...
                        <div className="visa-flex">
                          <p className="number-card">****-****-****-<span className="pt-1">{selectedCard.last4}</span></p>
                          <img src="assets/img/Home–new/visa-credit-card.png" className="visa-ixs" alt="" />
                        </div>
                      </div>
                    ) : (
                      <div className="w-100">
                        <div className="visa-flex p-0">
                          <p className="payment-card">No payment method added yet</p>
                          <a className="Add-promo" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#SECURE-RELIABLE">Add now</a>
                  ...
                  <div className="cost-ps">
                    ...
                    <div className="cost-grid">
                      ...
                      {promoApplied && (
                        <p className="Plan-cst-back flex">{promo}
                          <img src="assets/img/Home–new/chk-blue.svg" className="chk-ic" alt="" />
                        </p>
                      )}
                    </div>
                    <div className="cost-grid">
      ...
      <div className="modal fade" id="SECURE-RELIABLE" tabIdex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog signup">
            ...
            <div className="row m-0">
              <div className="col-lg-6 p-0">
                <div className="Add-credit-aline">
                  <img src="assets/img/Add-credit-card-details/Aman.png" className="hgyu" alt="" />
                </div>
              </div>
              <div className="col-lg-6 p-0">
                <Elements stripe={stripePromise}>
                  <AddCard getPaymentData={getPaymentData} addCardClicked={addCardClicked} handleAddCardSpinner={(e) => setAddCardClicked(e)} />
                </Elements>
              </div>
            </div>
          </div>
